...
const BookView = () => {
    ...
    const handleAddReview = async () => {
        ...
        try {
            ...
            console.log("Review data:", { bookId, rating: newRating, comment: newReview.trim() })
                  ...
                  {index < displayRating ? "⭐" : "☆"}
                        ...
                        <div className="book-detail-reviews-section">
                            ...
                            <div className="book-detail-add-review">
                                ...
                                />
                                <button className="book-detail-submit-review" onClick={handleAddReview} disabled={isSubmittingReview}>
